...
public class CommonApplicationBoot {
    ...
    @Autowired
    public CommonApplicationBoot(UrlMapper urlMapper, FileDownloadInfoRepository fileDownloadInfoRepository, SpeedTestWebSiteRepository speedTestWebSiteRepository) {
